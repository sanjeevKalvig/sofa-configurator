...
function MaterialPicker({clickedMeshCategory}) {
    const [hover, setHover] = useState(null);

    const materials = useMemo(() => {
      const mats = data.models.Sofa.materialsLods || [];
      return mats.filter((m) =>
        m.materialUsingCategories?.categoriesNames?.includes(clickedMeshCategory)
      );
    }, [clickedMeshCategory]);
    console.log(clickedMeshCategory,materials)
